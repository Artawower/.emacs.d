...
Sometime emacs trying to eat 100% cpu
...
#+BEGIN_SRC emacs-lisp
  (use-package turbo-log
    :quelpa ((turbo-log :fetcher github :repo "Artawower/turbo-log.el") :upgrade t)
...
#+BEGIN_SRC emacs-lisp
  (use-package rainbow-mode
    :ensure t
    :hook ((css-mode . rainbow-mode) (scss-mode . rainbow-mode) (org-mode . rainbow-mode))
    :defer 0.1
    :config
    )
  #+END_SRC
...
#+RESULTS:
: [nil 0 0 100000 nil require (yasnippet-snippets nil t) idle 0]
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;   (setq mmm-pug-mode-enter-hook (lambda ()
  ;;                                   (message "ME?")
  ;;                                   (pug-mode)))
...
#+BEGIN_SRC emacs-lisp
  (use-package paren-face
    ...
    :defer 0.1
    :config
    (setq global-paren-face-mode 1))
#+END_SRC

#+BEGIN_SRC emacs-lisp
  (use-package hl-defined
    :custom-face
    (hdefd-functions ((t (:foreground "#61afff" :slant normal))))
    (hdefd-undefined ((t (:foreground "#c678dd" :slant normal))))
    (hdefd-variables ((t (:foreground "#e06c75" :slant normal))))
    :ensure t
    :defer 0.1
    :config
    (setq hdefd-highlight-mode 1))
#+END_SRC
